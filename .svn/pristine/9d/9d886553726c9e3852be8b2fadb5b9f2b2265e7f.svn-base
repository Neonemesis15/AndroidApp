...
public class E_TblMstSubfamilia extends Entity {
	...
	public String getNom_subfamilia() {
		return nom_subfamilia;
	}

	public void setNom_subfamilia(String nom_subfamilia) {
		this.nom_subfamilia = nom_subfamilia;
	}
