...
public class E_Reporte_BloqueAzul_Mov {
	/*
	 ...
	 * Latitud n String Longitud o String Origen p q String Cod_Opcion
	 * List<E_Reporte_BloqueAzul_Mov_Detalle> Detalle r int Cod_Reporte
	 */
	...
	private String o;
	private String p;
	private List<E_Reporte_BloqueAzul_Mov_Detalle> q;
	private int r;

	
	public E_Reporte_BloqueAzul_Mov(E_TblMovReporteCab e_MovReporteCab, E_Usuario e_Usuario, TblPuntoGPS puntoGps, List<E_Reporte_BloqueAzul_Mov_Detalle> detalleReporte_m, E_TblFiltrosApp e_MovFiltrosApp) {
		...
		this.r = Utilidades.parseEntero(e_MovReporteCab.getCod_reporte());
	}
	...
	public List<E_Reporte_BloqueAzul_Mov_Detalle> getQ() {
		return q;
	}


	public void setQ(List<E_Reporte_BloqueAzul_Mov_Detalle> q) {
		this.q = q;
	}
