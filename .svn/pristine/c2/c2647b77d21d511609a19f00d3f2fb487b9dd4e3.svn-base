...
public class E_Reporte_Auditoria_Mov {
	/*
	...
	private String n;
	private String o;
	private List<E_Reporte_Auditoria_Mov_Detalle> p;
	private int q;

	
	public E_Reporte_Auditoria_Mov(E_TblMovReporteCab e_MovReporteCab, E_Usuario e_Usuario, TblPuntoGPS puntoGps, List<E_Reporte_Auditoria_Mov_Detalle> detalleReporte_m, E_TblFiltrosApp e_MovFiltrosApp) {
	...
	public List<E_Reporte_Auditoria_Mov_Detalle> getP() {
		return p;
	}

	public void setP(List<E_Reporte_Auditoria_Mov_Detalle> p) {
		this.p = p;
	}
