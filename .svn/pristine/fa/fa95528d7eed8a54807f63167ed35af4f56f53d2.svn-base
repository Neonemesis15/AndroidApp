...
public class E_Reporte_Impulso_Mov {
	...
	private String g; // Cod_Actividad
	private String h; // Fecha_Registro
	private String i; // Latitud
	private String j; // Longitud
	private String k; // Origen
	private List<E_Reporte_Impulso_Mov_Detalle> l; // Detalle> Detalle

	public E_Reporte_Impulso_Mov(E_TblMovReporteCab e_MovReporteCab, E_Usuario e_Usuario, TblPuntoGPS puntoGps, List<E_Reporte_Impulso_Mov_Detalle> detalle, E_TblFiltrosApp efiltros) {
	...
	public void setL(List<E_Reporte_Impulso_Mov_Detalle> l) {
		this.l = l;
	}

	public List<E_Reporte_Impulso_Mov_Detalle> getL() {
		return this.l;
	}
}
