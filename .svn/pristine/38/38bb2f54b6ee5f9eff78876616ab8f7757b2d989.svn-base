...
public class TBL_MOV_REP_PROMOCION extends Entity{
	int  id;
	int id_reporte_cab;
	String cod_competidora, cod_promocion, desc_promocion, sku_producto, mecanica;
	Date fecha_ini_promo, fecha_fin_promo;
	float precio_promo, precio_reg;
	int id_foto;

	public TBL_MOV_REP_PROMOCION() {
		super();
	}

	public TBL_MOV_REP_PROMOCION(int id, int id_reporte_cab,
			String cod_competidora, String cod_promocion,
			String desc_promocion, String sku_producto, String mecanica,
			Date fecha_ini_promo, Date fecha_fin_promo, float precio_promo,
			float precio_reg, int id_foto) {
		super();
		this.id = id;
	...
	public Date getFecha_ini_promo() {
		return fecha_ini_promo;
	}

	public void setFecha_ini_promo(Date fecha_ini_promo) {
		this.fecha_ini_promo = fecha_ini_promo;
	}

	public Date getFecha_fin_promo() {
		return fecha_fin_promo;
	}

	public void setFecha_fin_promo(Date fecha_fin_promo) {
		this.fecha_fin_promo = fecha_fin_promo;
	}
	...
	public void setPrecio_promo(float precio_promo) {
		this.precio_promo = precio_promo;
	}

	public float getPrecio_reg() {
		return precio_reg;
	}

	public void setPrecio_reg(float precio_reg) {
		this.precio_reg = precio_reg;
	}
