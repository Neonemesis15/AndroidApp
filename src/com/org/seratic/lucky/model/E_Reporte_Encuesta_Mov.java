...
public class E_Reporte_Encuesta_Mov {
	/*
	 ...
	 * List<E_Reporte_Potencial_Mov_Detalle> Detalle q int Cod_Reporte
	 */
	...
	private String o;
	private String p;
	private List<E_Reporte_Encuesta_Mov_Detalle> q;
	private String r;

	
	public E_Reporte_Encuesta_Mov(E_TblMovReporteCab e_MovReporteCab, E_Usuario e_Usuario, TblPuntoGPS puntoGps, List<E_Reporte_Encuesta_Mov_Detalle> detalleReporte_e, E_TblFiltrosApp e_MovFiltrosApp) {
		...
		this.q = detalleReporte_e;
		this.r = e_MovReporteCab.getCod_reporte();
	}
	...
	public List<E_Reporte_Encuesta_Mov_Detalle> getQ() {
		return q;
	}


	public void setQ(List<E_Reporte_Encuesta_Mov_Detalle> q) {
		this.q = q;
	}
