...
public class E_Reporte_Precio_Mov {
	...
	private String n; // Tipo_Precio
	private List<E_Reporte_Precio_Mov_Detalle> o; // Detalle> Detalle

	public E_Reporte_Precio_Mov(E_TblMovReporteCab e_MovReporteCab, E_Usuario e_Usuario, TblPuntoGPS puntoGps, List<E_Reporte_Precio_Mov_Detalle> detalle, E_TblFiltrosApp efiltros) {
		...
		if (efiltros != null) {
			this.e = efiltros.getCod_categoria() != null && !efiltros.getCod_categoria().trim().isEmpty() ? efiltros.getCod_categoria() : e_Usuario.getCodigo_compania().equalsIgnoreCase("1572")&&e_Usuario.getCod_canal().equalsIgnoreCase("1002")?null:"0";
			this.f = efiltros.getCod_marca() != null && !efiltros.getCod_marca().trim().isEmpty() ? efiltros.getCod_marca() : e_Usuario.getCodigo_compania().equalsIgnoreCase("1572")&&e_Usuario.getCod_canal().equalsIgnoreCase("1002")?null:"0";
		...
		this.m = e_MovReporteCab.getComentario() == null || e_MovReporteCab.getComentario().trim().isEmpty() ? null : e_MovReporteCab.getComentario();
		this.o = detalle;
	}
	...
	public void setO(List<E_Reporte_Precio_Mov_Detalle> o) {
		this.o = o;
	}

	public List<E_Reporte_Precio_Mov_Detalle> getO() {
		return this.o;
	}
}
